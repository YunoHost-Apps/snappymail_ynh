...
**Shipped version:** 2.18.3~ynh1 *(:warning: This is the `2.18.3` branch. The [`master` branch](https://github.com/YunoHost-Apps/snappymail_ynh/tree/master) used in the catalog is currently on version 2.18.2\~ynh1.)*
