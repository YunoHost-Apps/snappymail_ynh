...
**Version incluse :** 2.18.3~ynh1 *(:warning: Il s'agit de la branche `2.18.3`. La [branche `master`](https://github.com/YunoHost-Apps/snappymail_ynh/tree/master) utilisée dans le catalogue est actuellement en 2.18.2\~ynh1.)*
